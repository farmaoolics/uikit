...
var ConnectModal = function (_a) {
    ...
    return (React.createElement(Modal, { title: "Connect to a wallet", onDismiss: onDismiss },
        connectors.map(function (entry, index) { return (React.createElement(WalletCard, { login: login, walletConfig: entry, onDismiss: onDismiss, mb: index < connectors.length - 1 ? "8px" : "0" })); }),
...
var UserBlock = function (_a) {
    ...
    return (React.createElement("div", null, account ? (React.createElement(Button, { scale: "sm", variant: "tertiary", onClick: function () {
        ...
        }, style: { color: '#000' } }, accountEllipsis)) : (React.createElement(Button, { scale: "sm", onClick: function () {
...
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#FFFFFF", background: "#FFFFFF", backgroundDisabled: "#FFFFFF", backgroundAlt: "#696969", contrast: "#FFFFFF", dropdown: "#1E1D20", invertedContrast: "#191326", input: "#FFFFFF", inputSecondary: "#66578D", primaryDark: "#0098A1", tertiary: "#F40000", text: "#FFFFFF", textDisabled: "#666171", textSubtle: "#AEAEAE", borderColor: "#524B63", gradients: {
